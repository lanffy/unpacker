...
public class ModeLoader extends Loader{
	...
	public static void main(String[] args) {
		loadMode();
//		DefaultPackageMode mode = (DefaultPackageMode) Modes.getPackageMode("ftp-download");
		DefaultPackageMode mode = (DefaultPackageMode) Modes.getFieldProcessMode("ftp-download");
